...
public class Homme extends Omnivore {
    ...
    public void haut (Position pos){
       pos.y -=1;
       this.setposition(pos); 
    }
   
    public void bas (Position pos){
        pos.y += 1;
        this.setposition (pos); 
    }

    public void droite (Position pos){
        pos.x += 1;
        this.setposition (pos); 
    }

    public void gauche (Position pos){
        pos.x -= 1;
        this.setposition(pos);
    } 
    public void diagonalehautgauche(Position pos){
         pos.x -= 1;
         pos.y -=1;
         this.setposition(pos);
    } 
    public void diagonalehautdroit(Position pos){
         pos.x +=1;
         pos.y -=1;
         this.setposition(pos);
    } 
    public void diagonalebasgauche(Position pos){
        pos.x -= 1;
        pos.y +=1;
        this.setposition(pos);
    } 
    public void diagonalbasdroit(Position pos){
        pos.x +=1;
        pos.y +=1;
    } 
